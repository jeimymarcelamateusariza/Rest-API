...
function eliminarProducto(id){
   ...
   //El producto se elimino por lo tanto regresamos a 0 en la cantidad
...
function calcularPropina(){
    ...
    //Seleccionar el valor del % de la propina
...
function mostrarTotalHTML(subtotal, total, propina){
    ...
    subtotalSpan.classList.add('fs-normal');
    ...
    propinaSpan.classList.add('fs-normal');
    ...
    totalSpan.classList.add('fs-normal');
